...
let project = {
  interference: [107, 108, 109, 110, 111, 112, 113, 122, 123, 131, 136, 137, 138, 140, 141, 149, 152, 153, 160, 162, 163, 164, 182, 193, 212, 219, 236, 248, 250, 251],
  airplane_geometry: [89, 90, 93, 94, 95, 96, 97, 98, 101, 102, 103, 106, 117, 124, 135, 142, 155, 157, 161, 179, 183, 192, 194, 231, 235, 239, 241],
  pillars: [38, 40, 45, 48, 69, 70, 71, 73, 86, 91, 218],
  space_colonization: [51, 55, 56, 57, 60, 77, 126, 127, 159],
  flash_flooding: [39, 43, 47, 49, 50, 72, 74, 75, 121, 134, 233, 245, 246, 252],
  universe: [67, 68, 79, 81, 82, 85, 259],
  patterns: [41, 42, 44, 61, 62, 63, 64, 254, 255, 256],
  bubble_layout: [146, 147, 150, 154, 156],
  uncanny_values: [166, 167, 168, 186, 187, 189, 191, 196, 197, 200, 201, 202, 203, 206, 207, 208, 209, 210, 211, 213, 214, 217, 223, 225, 227, 229, 232, 234, 237, 238, 249], 
  rescaling_distances: [172, 173, 175, 216, 226, 247],

  // not used in presentation – but shows up as "part of some project, rather than event/promo"
  other: [37, 46, 52, 58, 59, 66, 76, 84, 87, 88, 99, 100, 104, 105, 119, 125, 128, 129, 130, 132, 133, 139, 151, 176, 177, 184, 195, 198, 199, 204, 215, 220, 221, 222, 230, 243, 257, 260],
};
...
let categories = {
  ...
  comm_used: [37, 38, 46, 48, 50, 59, 66, 67, 68, 76, 81, 85, 104, 105, 108, 117, 119, 125, 128, 130, 139, 147, 150, 151, 166, 167, 168, 173, 175, 177, 187, 192, 194, 195, 196, 198, 202, 203, 209, 211, 214, 217, 223, 223, 225, 225, 229], // actually used by the customer
  event_promo_test: [53, 54, 65, 78, 80, 83, 92, 114, 115, 116, 118, 120, 143, 144, 145, 148, 158, 165, 169, 170, 171, 174, 178, 180, 181, 185, 188, 190, 205, 224, 228, 240, 242, 244, 253, 258, 261, 262, 263],  // events, promotions, tests
  other: []
};
